...
export function OverviewPremium({ clientId, datePreset, metaData, currencySymbol, publicSlug, isPublicView = false }: Props) {
  ...
  const blocks = useMemo(() => {
    ...
    if (isVisible("performance")) {
      list.push({
        id: "performance",
        defaultLayout: { x: 0, y: 0, w: 9, h: 6, minW: 4, minH: 4 },
        node: (
          <PanelCard
    ...
    if (isVisible("funil")) {
      list.push({
        id: "funil",
        defaultLayout: { x: 0, y: 6, w: 4, h: 6, minW: 4, minH: 4 },
        node: (
          <PanelCard
    ...
    if (isVisible("lowticket")) {
      list.push({
        id: "lowticket",
        defaultLayout: { x: 0, y: 18, w: 7, h: 6, minW: 3, minH: 4 },
        node: (
          <PanelCard
            title="Vendas"
            noPadding
    ...
    if (isVisible("bestads")) {
      list.push({
        id: "bestads",
        defaultLayout: { x: 7, y: 18, w: 5, h: 6, minW: 3, minH: 4 },
        node: (
          <PanelCard
    ...
    if (isVisible("demografico")) {
      list.push({
        id: "demografico",
        defaultLayout: { x: 0, y: 24, w: 7, h: 6, minW: 4, minH: 4 },
        node: (
          <PanelCard
    ...
    if (isVisible("utms")) {
      list.push({
        id: "utms",
        defaultLayout: { x: 7, y: 24, w: 5, h: 6, minW: 5, minH: 4 },
        node: (
          <PanelCard
            title="Fontes (UTMs)"
            noPadding
