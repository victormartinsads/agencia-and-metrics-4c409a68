...
export function OverviewPremium({ clientId, datePreset, metaData, currencySymbol, publicSlug, isPublicView = false }: Props) {
  ...
  const blocks = useMemo(() => {
    ...
    if (isVisible("performance")) {
      list.push({
        id: "performance",
        defaultLayout: { x: 0, y: 0, w: 8, h: 7, minW: 4, minH: 6 },
        node: (
          <PanelCard
    ...
    if (isVisible("custos")) {
      list.push({
        id: "custos",
        defaultLayout: { x: 0, y: 7, w: 4, h: 6, minW: 2, minH: 4 },
        node: (
          <PanelCard
            title="Custos"
            noPadding
    ...
    if (isVisible("funil")) {
      list.push({
        id: "funil",
        defaultLayout: { x: 8, y: 0, w: 4, h: 7, minW: 4, minH: 6 },
        node: (
          <PanelCard
    ...
    if (isVisible("lowticket")) {
      list.push({
        id: "lowticket",
        defaultLayout: { x: 0, y: 13, w: 7, h: 6, minW: 3, minH: 4 },
        node: (
          <PanelCard
            title="Vendas"
            noPadding
    ...
    if (isVisible("mql")) {
      list.push({
        id: "mql",
        defaultLayout: { x: 4, y: 7, w: 4, h: 6, minW: 2, minH: 4 },
        node: (
          <PanelCard
            title="MQL & sMQL"
            actions={
    ...
    if (isVisible("bestads")) {
      list.push({
        id: "bestads",
        defaultLayout: { x: 7, y: 13, w: 5, h: 6, minW: 3, minH: 4 },
        node: (
          <PanelCard
    ...
    if (isVisible("demografico")) {
      list.push({
        id: "demografico",
        defaultLayout: { x: 0, y: 19, w: 7, h: 6, minW: 4, minH: 4 },
        node: (
          <PanelCard
    ...
    if (isVisible("utms")) {
      list.push({
        id: "utms",
        defaultLayout: { x: 7, y: 19, w: 5, h: 6, minW: 5, minH: 4 },
        node: (
          <PanelCard
            title="Fontes (UTMs)"
            noPadding
